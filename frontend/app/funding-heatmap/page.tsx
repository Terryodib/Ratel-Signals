  ...
  return (
    <main className="min-h-screen bg-[#05060A] px-6 py-8 text-white md:px-12">
      <div className="mx-auto max-w-6xl rounded-[32px] border border-white/10 bg-slate-950/80 p-8 shadow-glow backdrop-blur-xl">
        <h1 className="text-3xl font-semibold">Funding Heatmap</h1>
        <p className="mt-3 text-slate-400">Analyze which perpetual markets are overheating, which funding is extreme, and where squeeze risk is highest.</p>
      </div>
    </main>
  );
}
